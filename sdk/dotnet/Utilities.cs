...
namespace Pulumi.Confluent
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Confluent.version.txt");
    ...
    internal sealed class ConfluentResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public ConfluentResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
