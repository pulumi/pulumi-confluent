...
import com.pulumi.confluent.ServiceAccountArgs;
import com.pulumi.confluent.Utilities;
import com.pulumi.confluent.inputs.ServiceAccountState;
...
@ResourceType(type="confluent:index/serviceAccount:ServiceAccount")
public class ServiceAccount extends com.pulumi.resources.CustomResource {
    ...
    public ServiceAccount(String name, ServiceAccountArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("confluent:index/serviceAccount:ServiceAccount", name, args == null ? ServiceAccountArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private ServiceAccount(String name, Output<String> id, @Nullable ServiceAccountState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("confluent:index/serviceAccount:ServiceAccount", name, state, makeResourceOptions(options, id));
    }
